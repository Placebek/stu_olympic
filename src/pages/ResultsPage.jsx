...
const RANK_CONFIG = {
    ...
    3: {
        emoji: "🥉",
        gradient: "linear-gradient(135deg,#cd7c4e,#b45309)",
        glow: "rgba(180,83,9,0.25)",
        text: "#7c2d12",
        bg: "rgba(205,124,78,0.1)",
        border: "rgba(205,124,78,0.3)",
        size: "text-xl",
    },
};
            ...
            <div className="max-w-3xl mx-auto">
                ...
                >
                    ...
                    <p className="text-slate-500 text-sm">
                        {hasScores
                            ? `${rating.length} ${t.results.teamsTotal}`
                            : t.results.notStarted}
                    </p>

                    {/* Formula hint */}
                    <div
                        className="inline-flex items-center gap-3 mt-3 px-4 py-2 rounded-xl"
                        style={{
                        ...
                        >
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-indigo-600">
                                    {myRank.team_name} · #{myRank.variant}
                                </p>
                            </div>
                                ...
                                <div className="divide-y divide-white/30">
                                    {rest.map((entry) => (
                                        ...
                                        >
                                            ...
                                            />
                                            <div
                                                className="font-bold text-slate-700 text-sm flex-shrink-0"
                                                style={{
                                                    fontFamily:
                                                        '"Clash Display", sans-serif',
                                                }}
    ...
    return (
        <div className="flex flex-col gap-1 flex-shrink-0">
            ...
            <div
                className="flex items-center gap-1 text-xs"
                style={{
                    color: entry.tasks_checked > 0 ? "#059669" : "#94a3b8",
                }}
            >
                <FileCheck size={11} />
                <span className="font-semibold">{entry.tasks_correct * 5}</span>
                <span className="opacity-60">
                    ({entry.tasks_correct}/{entry.tasks_submitted})
                </span>
            </div>
        </div>
    );
