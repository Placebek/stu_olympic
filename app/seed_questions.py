...
QUESTIONS = [
    ...
    },
    {
        ...
        "options_ru": ["Distance Vector", "Link State", "Path Vector", "Hybrid", "Flooding"],
        "correct_index": 2,
    },
    {
        "category": "network",
    ...
    },
    {
        ...
        "options_ru": ["Sliding Window", "Congestion Window", "Slow Start", "Fast Retransmit", "Three Duplicate ACKs"],
        "correct_index": 0,
    },
    {
        "category": "network",
    ...
    },
    {
        ...
        "text_ru": "В IPv6 какой заголовок расширения отвечает за фрагментацию?",
        "options_kz": ["Hop-by-Hop Options", "Routing Header", "Fragment Header", "Destination Options", "Authentication Header"],
        "options_ru": ["Hop-by-Hop Options", "Routing Header", "Fragment Header", "Destination Options", "Authentication Header"],
        "correct_index": 2,
    },
    {
        "category": "network",
        "text_kz": "SDN (Software-Defined Networking) артықшылықтарының қайсысы дұрыс?",
        "text_ru": "Что из перечисленного является преимуществом SDN (Software-Defined Networking)?",
        ...
        "options_ru": ["Фиксированная маршрутизация на оборудовании", "Централизованное управление потоками через контроллер", "Отсутствие OpenFlow", "Увеличение нагрузки на коммутаторы", "Полное отсутствие безопасности"],
        "correct_index": 1,
    },
    {
        "category": "network",
    ...
    },
    {
        ...
        "text_ru": "Как называется атака, при которой атакующий отправляет множество SYN-пакетов без завершения handshake?",
        "options_kz": ["SYN Flood", "Smurf Attack", "Ping of Death", "ARP Poisoning", "DNS Amplification"],
        "options_ru": ["SYN Flood", "Smurf Attack", "Ping of Death", "ARP Poisoning", "DNS Amplification"],
        "correct_index": 0,
    },
    {
        "category": "network",
        "text_kz": "Көптеген TCP реализацияларында әдепкі терезе өлшемі қанша байт?",
        "text_ru": "Какой размер окна в TCP по умолчанию в большинстве реализаций (в байтах)?",
    ...
    },
    {
        ...
        "text_ru": "Какой протокол используется для обнаружения соседей в IPv6?",
        "options_kz": ["ARP", "ICMPv4", "NDP (Neighbor Discovery Protocol)", "IGMP", "DHCPv4"],
        "options_ru": ["ARP", "ICMPv4", "NDP (Neighbor Discovery Protocol)", "IGMP", "DHCPv4"],
        "correct_index": 2,
    },
    {
        "category": "network",
        "text_kz": "Қай хаттамада Dijkstra алгоритмі ең қысқа жолдарды есептеу үшін қолданылады?",
        "text_ru": "В каком протоколе применяется алгоритм Dijkstra для вычисления кратчайших путей?",
    ...
    },
    {
        ...
        "options_ru": ["Site-to-Site", "Remote Access", "Layer 2", "Layer 3", "SSL VPN"],
        "correct_index": 2,
    },
    {
        "category": "network",
        "text_kz": "Бір физикалық канал арқылы бірнеше VLAN-ды өткізуге мүмкіндік беретін технология қалай аталады?",
        "text_ru": "Как называется технология, позволяющая нескольким VLAN проходить по одному физическому каналу?",
        "options_kz": ["Trunking (802.1Q)", "Port Channel", "Spanning Tree", "QoS", "NAT"],
        "options_ru": ["Trunking (802.1Q)", "Port Channel", "Spanning Tree", "QoS", "NAT"],
        "correct_index": 0,
    },
    {
        "category": "network",
    ...
    },
    {
        ...
        "text_ru": "Что из перечисленного НЕ относится к протоколам канального уровня?",
    ...
    },
    {
        ...
        "text_ru": "Какой механизм используется в TCP для борьбы с перегрузкой сети?",
        "options_kz": ["Тек Sliding Window", "Congestion Avoidance + Slow Start", "Тек Exponential Backoff", "Selective Repeat", "Go-Back-N"],
        "options_ru": ["Тек Sliding Window", "Congestion Avoidance + Slow Start", "Тек Exponential Backoff", "Selective Repeat", "Go-Back-N"],
        "correct_index": 1,
    },
    {
        "category": "network",
        "text_kz": "IPv6-да one-to-many коммуникация үшін қандай адресация түрі қолданылады?",
        "text_ru": "Какой тип адресации используется в IPv6 для one-to-many коммуникации??",
        "options_kz": ["Unicast", "Multicast", "Anycast", "Broadcast", "Link-local"],
        "options_ru": ["Unicast", "Multicast", "Anycast", "Broadcast", "Link-local"],
        "correct_index": 1,
    },
    {
        "category": "network",
        "text_kz": "Қазіргі кәсіпорын желілерінде RIP-ті алмастыратын хаттама қалай аталады?",
        "text_ru": "Как называется протокол, заменяющий RIP в современных сетях предприятия?",
    ...
    },
    {
        ...
        "text_ru": "В чём преимущество IPv6 над IPv4 в плане мобильности?",
    ...
    },
    {
        ...
        "text_ru": "Что гарантирует свойство Isolation в ACID?",
        ...
        "options_ru": ["Все операции выполняются атомарно", "Транзакции не видят промежуточных результатов других транзакций", "База остаётся согласованной после транзакции", "Изменения сохраняются после коммита", "Высокая производительность"],
        "correct_index": 1,
    },
    {
        "category": "database",
        "text_kz": "Қай JOIN түрі екі кестедегі барлық жолдарды қайтарады, сәйкес келмейтін жерлерде NULL қояды?",
        "text_ru": "Какой тип JOIN возвращает все строки из обеих таблиц с NULL там, где нет соответствия?",
    ...
    },
    {
        ...
        "text_ru": "Что делает индекс B+-tree в большинстве СУБД?",
    ...
    },
    {
        ...
        "text_ru": "Какой оператор SQL используется для проверки существования подзапроса?",
    ...
    },
    {
        ...
        "options_ru": ["Количество строк в партиции", "Уникальный номер строки в пределах партиции", "Сумму значений", "Ранг без учёта дублей", "Среднее значение"],
        "correct_index": 1,
    },
    {
        "category": "database",
    ...
    },
    {
        ...
        "text_ru": "Какой тип ограничения запрещает дубликаты значений в столбце?",
    ...
    },
    {
        ...
        "options_ru": ["При высокой частоте INSERT", "Когда естественный ключ всегда уникален и неизменен", "При большом числе JOIN", "Для экономии места", "Никогда"],
        "correct_index": 1,
    },
    {
        "category": "database",
    ...
    },
    {
        ...
        "text_ru": "Какой тип данных в PostgreSQL/MySQL подходит для хранения JSON-документов с индексацией?",
    ...
    },
    {
        ...
        "text_ru": "Что возвращает RANK() в отличие от DENSE_RANK()?",
    ...
    },
    {
        ...
        "text_ru": "Какой оператор используется для объединения результатов двух SELECT без дубликатов?",
    ...
    },
    {
        ...
        "text_ru": "Что происходит при попытке вставить запись, нарушающую FOREIGN KEY?",
        ...
        "options_ru": ["Запись добавится с NULL", "Генерируется ошибка нарушения ограничения", "Запись добавляется, но FK становится NULL", "Транзакция откатится автоматически", "Зависит от ON DELETE CASCADE"],
        "correct_index": 1,
    },
    {
        "category": "database",
    ...
    },
    {
        ...
        "text_ru": "Что из перечисленного является примером триггера AFTER?",
    ...
    },
    {
        ...
        "text_ru": "Как называется аномалия, когда обновление одного факта требует изменения нескольких строк?",
        "options_kz": ["Insertion anomaly", "Deletion anomaly", "Update anomaly", "Selection anomaly", "Join anomaly"],
        "options_ru": ["Insertion anomaly", "Deletion anomaly", "Update anomaly", "Selection anomaly", "Join anomaly"],
        "correct_index": 2,
    },
    {
        "category": "database",
        "text_kz": "Қай ішкі сұрау бірнеше жол қайтара алады?",
        "text_ru": "Какой тип подзапроса может возвращать более одной строки?",
        "options_kz": ["Скалярлық", "Корреляцияланған", "WHERE шартта IN-пен", "SELECT-те өрнек ретінде", "Мүмкін емес"],
        "options_ru": ["Скалярный", "Коррелированный", "В условии WHERE с IN", "В SELECT как выражение", "Невозможно"],
        "correct_index": 2,
    },
    {
        "category": "database",
        ...
        "options_ru": ["Выполняет запрос", "Показывает план выполнения запроса", "Создаёт индекс", "Оптимизирует таблицу", "Удаляет дубликаты"],
        "correct_index": 1,
    },
    {
        "category": "database",
        "text_kz": "Қай агрегаттық функция NULL мәндерді елемейді?",
        "text_ru": "Какой агрегат игнорирует NULL-значения?",
        "options_kz": ["COUNT(*)", "COUNT(баған)", "SUM", "AVG", "COUNT(*)-дан басқасының барлығы"],
        "options_ru": ["COUNT(*)", "COUNT(сcolumn)", "SUM", "AVG", "Все кроме COUNT(*)"],
        "correct_index": 4,
    },
    {
        "category": "database",
    ...
    },
    {
        ...
        "text_ru": "Какой механизм в PostgreSQL позволяет создавать частичные индексы?",
        "options_kz": ["CREATE INDEX-те WHERE қолдану", "CREATE INDEX-те INCLUDE қолдану", "PARTITION BY", "USING GIN", "CONCURRENTLY"],
        "options_ru": ["WHERE в CREATE INDEX", "INCLUDE в CREATE INDEX", "PARTITION BY", "USING GIN", "CONCURRENTLY"],
        "correct_index": 0,
    },
]
